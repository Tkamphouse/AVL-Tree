...
int main(int argc, char* argv[])
{
  ...
  cout << "# Column 3 = hash map insert shuffled" << endl;
  cout << "# Column 4 = bst map insert shuffled" << endl;
  cout << "# Column 5 = avl map insert shuffled" << endl;
  
  cout << "# Column 6 = binsearch map erase shuffled" << endl;
  cout << "# Column 7 = hash map erase shuffled" << endl;
  cout << "# Column 8 = bst map erase shuffled" << endl;
  cout << "# Column 9 = avl map erase shuffled" << endl;  
  
  cout << "# Column 10 = binsearch contains shuffled" << endl;
  cout << "# Column 11 = hash map contains shuffled" << endl;
  cout << "# Column 12 = bst map contains shuffled" << endl;
  cout << "# Column 13 = avl map contains shuffled" << endl;
  
  cout << "# Column 14 = binsearch find range shuffled" << endl;
  cout << "# Column 15 = hash map find range shuffled" << endl;
  cout << "# Column 16 = bst map find range shuffled" << endl;
  cout << "# Column 17 = avl map find range shuffled" << endl;
  
  cout << "# Column 18 = binsearch sorted keys shuffled" << endl;
  cout << "# Column 19 = hash map sorted keys shuffled" << endl;
  cout << "# Column 20 = bst map sorted keys shuffled" << endl;
  cout << "# Column 21 = avl map sorted keys shuffled" << endl;

  cout << "# Column 22 = bst map height shuffled" << endl;
  cout << "# Column 22 = avl map height shuffled" << endl;
  cout << "# Column 24 = log base 2 of input size" << endl;  
